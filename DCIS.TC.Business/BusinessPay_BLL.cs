    ...
    public class BusinessPay_BLL
    {
        ...
        public dynamic GetCommonPayItemList(int start, int limit, string strOrderBy, dynamic data)
        {
            ...
            string strSql = @" SELECT [CommonPayNo]
                                      ...
                                      ,[CreateTime]
                                      ,[LastUpdateTime]
                                  FROM [CreateErp].[dbo].[SysBusinessPayItem]
        ...
        {
            string strRetun = "";
            string strSql = " SELECT COUNT(1) FROM dbo.SysBusinessPay WHERE CommonPayNo=" + CommonPayNo + " AND StepNo NOT IN(98) ";
            ...
            {
                strSql = " UPDATE dbo.SysBusinessPayItem SET IsDel='Y' WHERE CommonPayNo=" + CommonPayNo + "  ";
        ...
        {
            string strRetun = "";
            string strSql = " UPDATE dbo.SysBusinessPay SET StepNo=98,StepName='删除' WHERE BillNo='" + billNo + "'  ";
        ...
        public dynamic GetCommonPayInfo(int start, int limit, string strOrderBy, dynamic data)
        {
            ...
            else
            {
                strSql = @" SELECT [BillNo]
                                  ...
                                  ,[IsPayoff]
                                  ,[IsAppEnd]
                              FROM [CreateErp].[dbo].[SysBusinessPay]
        ...
        /// <returns></returns>
        public string InsertCommonPayItemInfo(SysBusinessPayItem_Entity entity)
        {
            string returnValue = "";
            string loginUserCode = HttpContext.Current.Session["UserCode"].ToString();
            ...
            try
            {
                string sqlStr = string.Format(@" INSERT INTO [CreateErp].[dbo].[SysBusinessPayItem]
                                                   ([ReceiveName]
                                                   ,[PayReason]
                                                   ,[TotalAmount]
                                                   ,[PaidAmount]
        ...
        /// <returns></returns>
        public string InsertCommonPayInfo(SysBusinessPay_Entity entity, string type)
        {
            string returnValue = "";
            try
            {
                DBUtil.BeginTrans();
                string billNo = new SqlHelper().getTableNo("SysBusinessPay", "BillNo", "BP");
                ...
                string flowQuery = @" SELECT [FlowId]
                                      ...
                                      WHERE  FlowCdode='BP' ORDER BY StepNo ";
        ...
        /// <param name="type"></param>
        /// <returns></returns>
        public string UpdateCommonPayInfo(SysBusinessPay_Entity entity, string type)
        {
            string returnValue = "";
            try
            {
        ...
        public dynamic GetCommonPayQueryInfo(int start, int limit, string strOrderBy, dynamic data)
        {
            ...
            string strSql = @" SELECT [BillNo]
                                      ...
                                      ,[IsPayoff]
                                      ,[IsAppEnd]
                                  FROM [CreateErp].[dbo].[SysBusinessPay] WHERE 1=1  ";
        ...
        public dynamic GetCommonPayAppInfo(int start, int limit, string strOrderBy, dynamic data)
        {
            ...
            string strSql = @" SELECT [BillNo]
                                      ...
                                      ,[IsPayoff]
                                      ,[IsAppEnd]
                                  FROM [CreateErp].[dbo].[SysBusinessPay] WHERE AppUserCode ='" + UserCode + "' AND IsAppEnd='N' ";
                ...
                else//通过审批
                {
                    ...
                    else//付款，结束审批流程
                    {
                        ...
                        if (dtIsPayOver.Rows.Count > 0)
                        {
                            ...
                            {
                                updatePurchaseContractSql = @" UPDATE SysBusinessPayItem SET PaidAmount=PaidAmount+" + decPayAmount.ToString() + ",IsPayoff='Y'  WHERE CommonPayNo='" + strPurBillNo + "'   ";
                            }
                            else
                            {
                                updatePurchaseContractSql = @" UPDATE SysBusinessPayItem SET PaidAmount=PaidAmount+" + decPayAmount.ToString() + "  WHERE CommonPayNo='" + strPurBillNo + "'   ";
                            }
                        }
                    }
                }
