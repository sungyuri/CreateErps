...
{
    [Serializable]
    [SqlTable("SysBusinessPay")]
    public class SysBusinessPay_Entity : BaseEntity
    {
        ...
        public SysBusinessPay_Entity(string connectionKey)
            : base(connectionKey)
        {
        }
        ...
        /// <param name="connectionKey">数据库连接池中的关键字</param>
        public SysBusinessPay_Entity(string billNo, string connectionKey)
            : base(connectionKey)
        {
            this.BillNo = billNo;
            this.SelectByPKeys();
