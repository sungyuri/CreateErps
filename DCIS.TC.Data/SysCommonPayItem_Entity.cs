...
{
    [Serializable]
    [SqlTable("SysCommonPayItem")]
   public class SysCommonPayItem_Entity:BaseEntity
    {
        ...
        /// Constructor
        /// </summary>
        public SysCommonPayItem_Entity()
            : base()
        {
        }
        ...
        public SysCommonPayItem_Entity(string connectionKey)
            : base(connectionKey)
        {
        }
        ...
        /// <param name="connectionKey">数据库连接池中的关键字</param>
        public SysCommonPayItem_Entity(int commonPayNo, string connectionKey)
            : base(connectionKey)
        {
