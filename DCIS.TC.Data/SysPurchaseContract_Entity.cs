...
{
    [Serializable]
    [SqlTable("SysPurchaseContract")]
   public class SysPurchaseContract_Entity:BaseEntity
    {
        ...
        /// Constructor
        /// </summary>
        public SysPurchaseContract_Entity()
            : base()
        {
        }
        ...
        public SysPurchaseContract_Entity(string connectionKey)
            : base(connectionKey)
        {
        }
        ...
        /// <param name="connectionKey">数据库连接池中的关键字</param>
        public SysPurchaseContract_Entity(string billNo, string connectionKey)
            : base(connectionKey)
        {
            this.BillNo = billNo;
            this.SelectByPKeys();
