...
{
    [Serializable]
    [SqlTable("TRAN_DOC_REPORT_BAK")]
    public class TRAN_DOC_REPORT_BAKEntity : BaseEntity
    {
         /// <summary>
        /// 表字段字符串常量
        /// </summary>
        ...
        /// Constructor
        /// </summary>
        public TRAN_DOC_REPORT_BAKEntity()
            : base()
        {
        }
        ...
        public TRAN_DOC_REPORT_BAKEntity(string connectionKey)
            : base(connectionKey)
        {
        }
        ...
        /// <param name="connectionKey">数据库连接池中的关键字</param>
        public TRAN_DOC_REPORT_BAKEntity(string schedule_id, string connectionKey)
            : base(connectionKey)
        {
