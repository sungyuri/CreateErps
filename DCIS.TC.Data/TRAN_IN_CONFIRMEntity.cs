...
{
    [Serializable]
    [SqlTable("TRAN_IN_CONFIRM")]
   public class TRAN_IN_CONFIRMEntity:BaseEntity
    {
          public sealed class Consts
        {
            ...
            public const string F_IMPORT_GOODS_TYPE = "IMPORT_GOODS_TYPE";
        ...
        public TRAN_IN_CONFIRMEntity(string connectionKey)
            : base(connectionKey)
        {
        }
        ...
        /// <param name="connectionKey">数据库连接池中的关键字</param>
        public TRAN_IN_CONFIRMEntity(string schedule_id, string connectionKey)
            : base(connectionKey)
        {
        ...
        private string _IMPORT_GOODS_TYPE;
        [SqlColumn(Consts.F_IMPORT_GOODS_TYPE)]
        public string IMPORT_GOODS_TYPE
        {
            get { return this._IMPORT_GOODS_TYPE; }
            set { this._IMPORT_GOODS_TYPE = value; this.SetValue(Consts.F_IMPORT_GOODS_TYPE, true); }
        }
