...
{
    [Serializable]
    [SqlTable("TRAN_IN_FORECAST")]
   public class TRAN_IN_FORECASTEntity:BaseEntity
    {
          public sealed class Consts
        {
            ...
            public const string F_LOADING_DATE = "LOADING_DATE";
        ...
        public TRAN_IN_FORECASTEntity(string connectionKey)
            : base(connectionKey)
        {
        }
        ...
        /// <param name="connectionKey">数据库连接池中的关键字</param>
        public TRAN_IN_FORECASTEntity(string schedule_id, string connectionKey)
            : base(connectionKey)
        {
        ...
        private decimal _LOADING_DATE;
        [SqlColumn(Consts.F_LOADING_DATE)]
        public decimal LOADING_DATE
        {
            get { return this._LOADING_DATE; }
            set { this._LOADING_DATE = value; this.SetValue(Consts.F_LOADING_DATE, true); }
        }
