...
{
    [Serializable]
    [SqlTable("TRAN_OUT_CONFIRM")]
   public class TRAN_OUT_CONFIRMEntity:BaseEntity
    {
        ...
        public TRAN_OUT_CONFIRMEntity(string connectionKey)
            : base(connectionKey)
        {
        }
        ...
        /// <param name="connectionKey">数据库连接池中的关键字</param>
        public TRAN_OUT_CONFIRMEntity(string schedule_id, string connectionKey)
            : base(connectionKey)
        {
