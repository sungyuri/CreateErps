...
{
    [Serializable]
    [SqlTable("TRAN_OUT_FORECAST")]
  public  class TRAN_OUT_FORECASTEntity:BaseEntity
    {
           public sealed class Consts
        {
            ...
            public const string F_START_PORT_CODE = "START_PORT_CODE";
            public const string F_END_PORT_CODE = "END_PORT_CODE";
        ...
        /// Constructor
        /// </summary>
        public TRAN_OUT_FORECASTEntity()
            : base()
        {
        }
        ...
        public TRAN_OUT_FORECASTEntity(string connectionKey)
            : base(connectionKey)
        {
        }
        ...
        /// <param name="connectionKey">数据库连接池中的关键字</param>
        public TRAN_OUT_FORECASTEntity(string schedule_id, string connectionKey)
            : base(connectionKey)
        {
        ...
        private string _START_PORT_CODE;
        [SqlColumn(Consts.F_START_PORT_CODE)]
        public string START_PORT_CODE
        {
            get { return this._START_PORT_CODE; }
            set { this._START_PORT_CODE = value; this.SetValue(Consts.F_START_PORT_CODE, true); }
        }

        private string _END_PORT_CODE;
        [SqlColumn(Consts.F_END_PORT_CODE)]
        public string END_PORT_CODE
        {
            get { return this._END_PORT_CODE; }
            set { this._END_PORT_CODE = value; this.SetValue(Consts.F_END_PORT_CODE, true); }
        }
