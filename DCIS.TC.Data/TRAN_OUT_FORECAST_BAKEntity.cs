...
{
    [Serializable]
    [SqlTable("TRAN_OUT_FORECAST_BAK")]
   public class TRAN_OUT_FORECAST_BAKEntity:BaseEntity
    {
        ...
        /// Constructor
        /// </summary>
        public TRAN_OUT_FORECAST_BAKEntity()
            : base()
        {
        }
        ...
        public TRAN_OUT_FORECAST_BAKEntity(string connectionKey)
            : base(connectionKey)
        {
        }
        ...
        /// <param name="connectionKey">数据库连接池中的关键字</param>
        public TRAN_OUT_FORECAST_BAKEntity(string schedule_id, string connectionKey)
            : base(connectionKey)
        {
