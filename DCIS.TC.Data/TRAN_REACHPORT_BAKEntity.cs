...
{
    [Serializable]
    [SqlTable("TRAN_REACHPORT_BAK")]
   public class TRAN_REACHPORT_BAKEntity : BaseEntity
    {
        ...
        /// Constructor
        /// </summary>
        public TRAN_REACHPORT_BAKEntity()
            : base()
        {
        }
        ...
        public TRAN_REACHPORT_BAKEntity(string connectionKey)
            : base(connectionKey)
        {
        }
        ...
        /// <param name="connectionKey">数据库连接池中的关键字</param>
        public TRAN_REACHPORT_BAKEntity(string schedule_id, string connectionKey)
            : base(connectionKey)
        {
