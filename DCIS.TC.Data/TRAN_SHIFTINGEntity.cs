...
{
    [Serializable]
    [SqlTable("TRAN_SHIFTING")]
    public class TRAN_SHIFTINGEntity : BaseEntity
    {
        public sealed class Consts
        {
            public const string F_SHIFTID = "SHIFTID";
            ...
            public const string F_BERTH_NOW_CODE = "BERTH_NOW_CODE";
            public const string F_BERTH_TO_CODE = "BERTH_TO_CODE";
            public const string F_SHIFT_DATE = "SHIFT_DATE";
            ...
            // public const string F_SCHEDULE_ID = "SCHEDULE_ID";//R_STATUE
            public const string F_R_STATUE = "R_STATUE";//R_STATUE
        }
        /// <summary>
        /// Constructor
        /// </summary>
        public TRAN_SHIFTINGEntity()
            : base()
        {
        }
        ...
        public TRAN_SHIFTINGEntity(string connectionKey)
            : base(connectionKey)
        {
        }
        ...
        /// <param name="connectionKey">数据库连接池中的关键字</param>
        public TRAN_SHIFTINGEntity(string shiftid, string connectionKey)
            : base(connectionKey)
        {
        ...
        [SqlColumn(Consts.F_SHIFTID, true)]
        public string SHIFTID
        {
            get { return this._SHIFTID; }
            set { this._SHIFTID = value; this.SetValue(Consts.F_SHIFTID, true); }
        }

        private string _SCHEDULE_ID;
        [SqlColumn(Consts.F_SCHEDULE_ID)]
        ...
        private string _BERTH_NOW_CODE;
        [SqlColumn(Consts.F_BERTH_NOW_CODE)]
        public string BERTH_NOW_CODE
        {
            get { return this._BERTH_NOW_CODE; }
            set { this._BERTH_NOW_CODE = value; this.SetValue(Consts.F_BERTH_NOW_CODE, true); }
        }


        private string _BERTH_TO_CODE;
        [SqlColumn(Consts.F_BERTH_TO_CODE)]
        public string BERTH_TO_CODE
        {
            get { return this._BERTH_TO_CODE; }
            set { this._BERTH_TO_CODE = value; this.SetValue(Consts.F_BERTH_TO_CODE, true); }
        }

        private string _SHIFT_DATE;
        [SqlColumn(Consts.F_SHIFT_DATE)]
        public string SHIFT_DATE
        {
            get { return this._SHIFT_DATE; }
            set { this._SHIFT_DATE = value; this.SetValue(Consts.F_SHIFT_DATE, true); }
        }
