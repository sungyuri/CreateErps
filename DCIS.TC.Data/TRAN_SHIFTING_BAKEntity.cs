...
{
    [Serializable]
    [SqlTable("TRAN_SHIFTING_BAK")]
    public class TRAN_SHIFTING_BAKEntity : BaseEntity
    {
        ...
        /// Constructor
        /// </summary>
        public TRAN_SHIFTING_BAKEntity()
            : base()
        {
        }
        ...
        public TRAN_SHIFTING_BAKEntity(string connectionKey)
            : base(connectionKey)
        {
        }
        ...
        /// <param name="connectionKey">数据库连接池中的关键字</param>
        public TRAN_SHIFTING_BAKEntity(string shiftid, string connectionKey)
            : base(connectionKey)
        {
