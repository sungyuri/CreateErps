//采购合同
Ext.define('TCSYS.erp.DelPurchaseContract', {
    extend: 'Ext.panel.Panel',
    title: '采购合同删单',
    name: 'DelPurchaseContract',
    alias: "widget.DelPurchaseContract",
    closable: true,
    layout: {
        type: 'vbox',
        align: 'stretch'
    ...
    initComponent: function () {
        ...
        var store = Ext.create('TCEPORT.Store', {
            autoLoad: true,
            url: 'DelPurchaseContract_BLL/Get',
            addUrl: 'DelPurchaseContract_BLL/Insert',
            updateUrl: 'DelPurchaseContract_BLL/Update',
            deleteUrl: 'DelPurchaseContract_BLL/Delete',
            fields: [
                'BillNo',
                'ContractCode',
                'ContractCodeA',
        ...
        var gridstore = Ext.create('TCEPORT.Store', {
            url: 'DelPurchaseContract_BLL/GetPurchaseContractDetail',
        ...
        var applogstore = Ext.create('TCEPORT.Store', {
            url: 'DelPurchaseContract_BLL/GetPurchaseAppLog',
        ...
        var SaleContractMgrWindow = {
            ...
            items: [{
                xtype: 'datagrid',
                itemId: 'DelPurchaseContractAddAppLog',
                width: 895,
                height: 128,
                hidden: true,
                border: false,
                           ...
                           change: function (field, value) {
                               if (value == null) {
                                   ...
                                   if (this.up('window').operationType == "update") {
                                       ...
                                       callapi("DelPurchaseContract_BLL/checkPurchaseContractCode", { ContractCode: value, billNo: strBillNo }, function (result) {
                                           if (result == 'yes') {
                                   ...
                                   if (this.up('window').operationType == "add") {
                                       //  var strBillNo = this.up('window').record.get('BillNo');
                                       callapi("DelPurchaseContract_BLL/checkPurchaseContractCode", { ContractCode: value, billNo: 'add' }, function (result) {
                                           if (result == 'yes') {
                                               //var txt = this.up('form').down('textfield[name="ContractCode"]');
                                               Ext.Msg.show({
                                                   title: "提示",
                ...
                handler: function (sender) {
                    ...
                    if (record != null) {
                        ...
                        gridstore.load({
                            ...
                            var object = Ext.ComponentQuery.query('[itemId="DelPurchaseContractAddAppLog"]')[0];
                            object.show();
                            applogstore.load({
