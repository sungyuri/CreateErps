//采购付款审核
Ext.define('TCSYS.erp.PurchasePayApp', {
    extend: 'Ext.panel.Panel',
    title: '采购付款审批',
    name: 'PurchasePayApp',
    alias: "widget.PurchasePayApp",
    closable: true,
    layout: {
        type: 'vbox',
        align: 'stretch'
    ...
    initComponent: function () {
        ...
        var purchasePayAppStore = Ext.create('TCEPORT.Store', {
            url: 'PurchasePay_BLL/GetPurchasePayAppInfo',
            autoLoad: true,
        ...
        var PurchaseContractPayAppWindow = {
            xtype: 'datawindow',
            title: '采购付款单',
            ...
            tbar: [{
                ...
                handler: function (sender) {
                    ...
                    purchasePayAppStore["updateData"]({
        ...
        this.add({
            ...
            tbar: [{
                ...
                iconCls: 'icon-search',
                handler: function (sender) {
                    var object = Ext.ComponentQuery.query('[itemId="purchasePayAppSelect"]')[0]
