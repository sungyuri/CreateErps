Ext.define("TCEPORT.SearchBoxNoField", {
    extend: "Ext.form.field.Picker",
    alias: "widget.SearchBoxNoField",
    control: null,
    store: null,
    ...
    onTriggerClick: function () {
        ...
        if (store != null) {
            if (this.multiSelect) {
                ...
                var element = Ext.create('TCEPORT.SearchBoxNoWindow', {
                    store: this.store,
                    pageSize: this.pageSize,
                    displayField: this.displayField,
                    extraParams: this.extraParams,
            ...
            if (control["xtype"] != null) {
                ...
                var element = Ext.create("TCEPORT.SearchBoxNoFieldWindow", control);
                control.searchField = me;
                element.show();
                return;
            }
