Ext.define('TCSYS.transport.shipInCfmDataRecord', {
    extend: 'Ext.panel.Panel',
    title: '船舶进港确申报列表',
    name: 'shipInPreDataRecord',
    alias: "widget.shipInCfmDataRecord",
    closable: true,
    layout: {
        type: 'vbox',
        align: 'stretch'
    ...
    initComponent: function () {
        ...
        var store = Ext.create('TCEPORT.Store', {
            autoLoad: true,
            url: 'ShipInCfmDataRecord_BLL/Get',
            addUrl: 'ShipInCfmDataRecord_BLL/Insert',
            updateUrl: 'ShipInCfmDataRecord_BLL/Update',
            deleteUrl: 'ShipInCfmDataRecord_BLL/Delete',
            fields: [
                'SCHEDULE_ID',
                'IMO',
                'SHIP_NO',
                ...
                'IMPORT_GOODS_TYPE_TEXT'
            ]
        });

        var storeCombo = Ext.create('TCEPORT.Store', {
            autoload: false,
            url: 'ShipInCfmDataRecord_BLL/GetCfmShip',  
            updateUrl: 'ShipInCfmDataRecord_BLL/Update',
            fields: [
                ...
                { name: 'LOADING_DATE', mapping: 'LOADING_DATE' },
                    ...
                    items: [{
                        ...
                        items: [{
                            ...
                            listeners: {
                                beforerender: function (tigger, opt) {
                                    if (record) {
                                        tigger.setHiddenValue(record.get('IMPORT_GOODS_TYPE'));
                                        tigger.setValue(record.get('IMPORT_GOODS_TYPE_TEXT'));
                                    }
                                }
                            }
                        }]
            ...
            columns: [{
                ...
                items: [{
                    ...
                    handler: function (grid, rowIndex, colIndex, sender) {
                        ...
                        //storeScheduleInfo.load();
                        //alert(me.BasicInfoPK);
