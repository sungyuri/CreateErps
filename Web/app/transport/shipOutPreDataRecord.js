Ext.define('TCSYS.transport.shipOutPreDataRecord', {
    extend: 'Ext.panel.Panel',
    title: '离港预报',
    name: 'shipOutPreDataRecord',
    alias: "widget.shipOutPreDataRecord",
    itemId: 'shipOutPreDataItemId',
    plain: true,
    closable: true,
    layout: {
        type: 'vbox',
    ...
    initComponent: function () {
        ...
        var store = Ext.create('TCEPORT.Store', {
            autoLoad: true,
            url: 'ShipOutPreDataRecord_BLL/Get',
            addUrl: 'ShipOutPreDataRecord_BLL/Insert',
            updateUrl: 'ShipOutPreDataRecord_BLL/Update',
            deleteUrl: 'ShipOutPreDataRecord_BLL/Delete',
            fields: [
                'SHIP_NO',
                'IMO',
                'SHIP_NAME',
        ...
        var storeCombo = Ext.create('TCEPORT.Store', {
            autoLoad: false,
            url: 'ShipOutPreDataRecord_BLL/GetArrShip',
            updateUrl: 'ShipOutPreDataRecord_BLL/Update',
            fields: [
                'SHIP_NO',
                'IMO',
        ...
        this.add({
            ...
            store: store,
            xtype: 'form',
            itemId: 'shipOutPreDataRecordSelect',
            //title: '查询条件',
            collapsible: true,
            layout: {
                type: 'vbox'
        ...
        this.add({
            ...
            tbar: [{
                ...
                xtype: 'button',
                handler: function (sender) {
                    var object = Ext.ComponentQuery.query('[itemId="shipOutPreDataRecordSelect"]')[0]
                    var form = object.getForm();
                    var obj = form.getValues();
