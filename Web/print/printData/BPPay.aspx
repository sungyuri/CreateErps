<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BPPay.aspx.cs" Inherits="Web.print.printData.BPPay" %>
...
<script runat="server"> 
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       // OledbReportData.GenNodeXmlData(this, "select * from Customers order by Region,City", false);
           ...
           string ParameterQuerySQL = " SELECT * FROM  SysBusinessPay  WHERE BillNo='" + billNo + "'  ";
